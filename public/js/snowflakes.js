  ...
  function setStyle(dom, props) {
    Object.keys(props).forEach(function(originalKey) {
      ...
      if (animationPrefix && originalKey.search("animation") > -1) {
        key =
          animationPrefix +
          originalKey[0].toUpperCase() +
          originalKey.substr(1);
      }
  ...
  var Flake =
    ...
    (function() {
      ...
      function Flake(container, containerHeight, params) {
        ...
        if (params.types) {
          innerFlake.classList.add(
            "snowflake__inner_type_" + getRandom(0, params.types)
          );
        }
    ...
    (function() {
      ...
      function Snowflakes(params) {
        ...
        this._isBody =
          ...
          document.querySelector("#snowflakes-container");
        ...
        if (imagesStyle) {
          this._imagesStyleNode = this._injectStyle(
            imagesStyle.replace(
              /%7Bcolor%7D/g,
      ...
      _createClass(Snowflakes, [
        ...
        },
        {
          ...
          value: function _getAnimationStyle() {
            ...
            var css = "@-webkit-keyframes snowflake_y{from{-webkit-transform:translateY(0px)}to{-webkit-transform:translateY("
              .concat(
                height,
            ...
            for (var i = 0; i <= Flake.maxInnerSize; i++) {
              var left =
                (Flake.calcSize(i, this.params) - this.params.minSize) * 4 +
                "px";
              css += "@-webkit-keyframes snowflake_x_"
                .concat(
                  i,
        ...
        },
        {
          ...
          value: function _removeStyle() {
            ...
            if (Snowflakes._count <= 0) {
              ...
              if (Snowflakes._mainStyleNode) {
                Snowflakes._mainStyleNode.parentNode.removeChild(
                  Snowflakes._mainStyleNode
                );
            ...
            if (this._animationStyleNode) {
              this._animationStyleNode.parentNode.removeChild(
                this._animationStyleNode
              );
            ...
            if (this._imagesStyleNode) {
              this._imagesStyleNode.parentNode.removeChild(
